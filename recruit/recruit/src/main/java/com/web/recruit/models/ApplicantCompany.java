...
@IdClass(ApplicantCompanyId.class)
public class ApplicantCompany {
    ...
    public Long getCompanyApplicantId() {
        return companyApplicantId;
    }

    public void setCompanyApplicantId(Long companyApplicantId) {
    ...
    public String toString() {
        return "ApplicantCompany{" +
                "ApplicantCompanyId=" + new ApplicantCompanyId(companyApplicantId, applicantCompanyId) +
                "applicant=" + applicant +
                ", company=" + company +
                ", beginDate=" + beginDate +
                ", endDate=" + endDate +
